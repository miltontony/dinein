...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.preparation'
        db.add_column(u'web_recipe', 'preparation',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.preparation'
        db.delete_column(u'web_recipe', 'preparation')
    ...
    models = {
        ...
        u'web.userrecipes': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'recipes'", 'default': 'None', 'to': u"orm['web.Recipe']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
